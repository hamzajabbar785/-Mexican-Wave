...
// and raise their arms. Immediately upon stretching to full height, the spectator returns to the usual seated 
// position.
...
const wave = (str) => {
    let arr = str.split("")
    return arr.map((W, i) => str.slice(0, i) + W.toUpperCase() + str.slice(i + 1))
    .filter((w) => w !== str)
}
